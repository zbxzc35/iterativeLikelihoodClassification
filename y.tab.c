...
{
       6,     7,     1,     1,     2,    10,     8,     0,    12,     9,
      -5,    13,    11
};

static const yytype_int8 yycheck[] =
{
       2,     0,     3,     3,     5,     5,     4,    -1,    10,     6,
       4,     6,     8
};
...
#line 59 "mva.y"
    {
	int l1=strlen((yyvsp[(1) - (3)]))		; 
	int l2=strlen((yyvsp[(3) - (3)]))		; 
	(yyval)=(char*)malloc(l1+l2+4)	;
	sprintf((yyval),"%s|%s|+",(yyvsp[(3) - (3)]),(yyvsp[(1) - (3)]))	;
	free((yyvsp[(1) - (3)]))			;
	free((yyvsp[(3) - (3)]))			;
	sprintf(expVal,"%s",(yyval))		;
}
    break;
...
#line 70 "mva.y"
    {
	(yyval)=strdup((yyvsp[(2) - (3)])); free((yyvsp[(2) - (3)]));
}
    break;

  case 4:
#line 75 "mva.y"
    {(yyval)=strdup((yyvsp[(1) - (1)])); free((yyvsp[(1) - (1)]));}
    break;
